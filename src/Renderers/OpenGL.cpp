...
OpenGLRenderer::OpenGLRenderer() : m_vertexBufferFreeIndex(0)
{
    ...
    */
    ...
    Type conversions
    */
    registerTypeConversion(TYPE_INFO<       float>, {.glTypeSpec = floatSpec, .setUniform = [](GLint location, const Variant &hostValue) {                                                               glUniform1f(location, hostValue.get<float>()                                    );}});
    ...
    registerTypeConversion(TYPE_INFO<         int>, {.glTypeSpec = intSpec,   .setUniform = [](GLint location, const Variant &hostValue) {                                                               glUniform1i(location, hostValue.get<int>()                                      );}});
    ...
    registerTypeConversion(TYPE_INFO<unsigned int>, {.glTypeSpec = uintSpec,  .setUniform = [](GLint location, const Variant &hostValue) {                                                              glUniform1ui(location, hostValue.get<unsigned int>()                             );}});
    ...
    registerTypeConversion(TYPE_INFO<        bool>, {.glTypeSpec = boolSpec,  .setUniform = [](GLint location, const Variant &hostValue) {                                                               glUniform1i(location, hostValue.get<bool>() ? 1 : 0                             );}});
